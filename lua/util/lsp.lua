...
M.on_attach = function(client, bufnr)
	...
	mapkey("<leader>dl", "Lspsaga show_line_diagnostics", "n", opts) -- show diagnostics for line
	mapkey("<leader>dc", "Lspsaga show_cursor_diagnostics", "n", opts) -- show diagnostics for cursor
