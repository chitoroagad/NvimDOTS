...
M.on_attach = function(client, bufnr)
	...
	mapkey("<leader>D", "Lspsaga show_buf_diagnostics", "n", opts) -- show  diagnostics for line
	mapkey("<leader>d", "Lspsaga show_line_diagnostics", "n", opts) -- show diagnostics for cursor
